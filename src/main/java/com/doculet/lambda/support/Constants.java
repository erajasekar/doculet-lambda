...
public class Constants {
    ...
    public static int THUMBNAIL_WIDTH = 960;
    public static int THUMBNAIL_HEIGHT = 600;
    public static final String THUMBNAIL_URL = "https://doculet.net/static/doculet-logo1.png";
